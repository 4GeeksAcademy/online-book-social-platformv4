...
export const CreateAccount = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const ig_username = event.target.ig_username.value;const favorite_book = event.target.favorite_book.value;
    ...
    actions.createUser(name, email, password, profession, bio, twitter_username, ig_username, favorite_genres, favorite_author, favorite_quote, number_books_read)
